...
const Header = () => {
  ...
  return (
    <header className='bg-accent p-4 flex justify-between items-center relative'>
      {/* Logo / Site Title */}
      <div>
      ...
      {isMobileMenuOpen && (
        <div
          ref={dropdownRef}
          className='bg-accent absolute top-full right-4 rounded-md shadow-lg w-48 mt-2 z-50'
        >
